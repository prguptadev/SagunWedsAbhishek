$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Sagun and Abhishek's Wedding",

      // Event start date
      start: new Date("Mar 14, 2021 10:00"),
      ...
      end: new Date("Mar 15, 2021 00:00"),

      // Event Address
      address: "Red Fox Hotel, Alwar",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Prashant Gupta at +91 9092951847.",
    },
  });
...
// Google map
function initMap() {
  var location = { lat: 27.53566453435741, lng: 88.27027720000001 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 27.53566453435741, lng: 88.27027720000001 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
